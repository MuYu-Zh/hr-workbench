...
const routes = [
  ...
  { path: '/attendance/monthly', name: 'attendance-monthly', component: () => import('@/views/Attendance/Monthly.vue'), meta: { title: '月度考勤汇总表', crumb: '考勤管理', icon: '⏰' } },
  { path: '/attendance/requests', name: 'attendance-requests', component: () => import('@/views/Attendance/Requests.vue'), meta: { title: '请假 / 加班 / 出差申请审批', crumb: '考勤管理' } },
  { path: '/attendance/remedy', name: 'attendance-remedy', component: () => import('@/views/Attendance/Remedy.vue'), meta: { title: '补卡申请记录', crumb: '考勤管理' } },
  { path: '/attendance/anomaly', name: 'attendance-anomaly', component: () => import('@/views/Attendance/Anomalies.vue'), meta: { title: '考勤异常预警', crumb: '考勤管理' } },
  { path: '/attendance/schedule', name: 'attendance-schedule', component: () => import('@/views/Attendance/Schedule.vue'), meta: { title: '排班管理', crumb: '考勤管理' } },
